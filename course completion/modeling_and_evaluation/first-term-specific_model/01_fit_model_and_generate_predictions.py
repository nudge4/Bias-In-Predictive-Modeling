...
train_df = train_df[train_df.first_ind == 1]
test_df = test_df[test_df.first_ind == 1]
std_list = train_df.loc[:,predictors].describe().loc['std',:]
exclude = set(list(std_list[std_list == 0].index))
