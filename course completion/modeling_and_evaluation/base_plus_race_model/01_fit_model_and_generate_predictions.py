...
gender_df = pd.read_stata("../bias_analyses/race.dta").loc[:,['vccsid', 'male', 'afam','other','white','asian','hisp']]
...
predictors = list(pickle.load(open("../bias_analyses/predictors.p", "rb"))) + ['male','afam','other','white','asian','hisp', 'pell_ever_0', 'pell_ever_1', 'pell_target_0', 'pell_target_1', 'firstgen_0', 'firstgen_1', 'distance', 'median_income_households', 'perc_below_pov']
