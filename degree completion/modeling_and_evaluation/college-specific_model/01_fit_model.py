...
for r in ['J._Sargeant_Reynolds', 'John_Tyler', 'Northern_Virginia', 'Tidewater', 'Thomas_Nelson']:

    # Load the training/validation sample
    print(r)
    train_df = train_df_all[train_df_all.college == r]
    test_df = test_df_all[test_df_all.college == r]
